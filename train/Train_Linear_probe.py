...
class Linear_probe_train:
    ...
    def train_ID(self, seed=1064200250, test=1):
        ...
        projection_model=self.md.Linear_probe(hidden_dim=self.hidden_dim,output_dim=512, num_layers=self.num_layers, dropout=self.dropout)
        ...
        for epoch in range(self.num_epochs):
            ...
            with torch.no_grad():
                ...
                for batch_trans_val in dataloader_trans_val:
                    ...
                    loss_trans_val, acc_trans_val= projection_model( image_features_trans_val, text_features, target_index_trans_val, self.t)
            ...
            epoch_loss_trans_val = running_loss_trans_val / len(dataloader_val)
            epoch_acc_trans_val = (running_corrects_trans_val / size_val) * 100
            if self.wnb:
                wandb.log({"val_loss": epoch_loss_val, "val_acc": epoch_acc_val,"trans_val_loss": epoch_loss_trans_val, "trans_val_acc": epoch_acc_trans_val})
                ...
                if test:
                    ...
                    with torch.no_grad():
                        ...
                        for batch_cis_test in dataloader_cis_test:
                            ...
                            loss_cis_test, acc_cis_test = projection_model( image_features_cis_test, text_features, target_index_cis_test, self.t)
                        ...
                        for batch_trans_test in dataloader_trans_test:
                            ...
                            loss_trans_test, acc_trans_test = projection_model(image_features_trans_test, text_features, target_index_trans_test, self.t)
