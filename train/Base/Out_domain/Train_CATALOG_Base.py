...
if __name__ == "__main__":
    ...
    parser.add_argument('--ruta_features_train', type=str,
                        default="../../../features/Features_serengeti/standard_features/Features_CATALOG_train_16.pt",
                        help='Training path')
    parser.add_argument('--ruta_features_val', type=str,
                        default="../../../features/Features_serengeti/standard_features/Features_CATALOG_val_16.pt",
    ...
    parser.add_argument('--text_features', type=str,
                        default="../../../features/Features_serengeti/standard_features/Text_features_16.pt",
