...
import argparse
import datetime
from models import CATALOG_Projections as md
import pandas as pd
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ruta_features_train', type=str,
                        default="../../../features/Features_terra/standard_features/Features_CATALOG_train_16.pt",
                        help='Training path')
    parser.add_argument('--ruta_features_val1', type=str,
                        default="../../../features/Features_terra/standard_features/Features_CATALOG_cis_val_16.pt",
                        help='Cis-Val path')
    parser.add_argument('--ruta_features_val2', type=str,
                        default="../../../features/Features_terra/standard_features/Features_CATALOG_trans_val_16.pt",
                        help='Trans-Val path')
    parser.add_argument('--ruta_features_test1', type=str,
                        default="../../../features/Features_terra/standard_features/Features_CATALOG_cis_test_16.pt",
                        help='Cis-Test path')
    parser.add_argument('--ruta_features_test2', type=str,
                        default="../../../features/Features_terra/standard_features/Features_CATALOG_trans_test_16.pt",
                        help='Trans-Test path')
    parser.add_argument('--text_features', type=str,
                        default="../../../features/Features_terra/standard_features/Text_features_16.pt",
                        help='Text features for training')  # Path for the features of the descriptions categories (Extracted by CLIP text encoder)
    
    parser.add_argument('--weight_Clip', type=float, default=0.4848, help='Alpha')
    parser.add_argument('--num_epochs', type=int, default=74, help='Number of epochs')
    ...
    parser.add_argument('--dropout', type=float, default=0.2658, help='dropout ')
    parser.add_argument('--hidden_dim', type=int, default=1863, help='hidden_dim ')
    ...
    parser.add_argument('--momentum', type=float, default=0.909, help='momentum ')
    ...
    ruta_features_cis_val = args.ruta_features_val1
    ruta_features_cis_test = args.ruta_features_test1
    ruta_features_trans_val = args.ruta_features_val2
    ruta_features_trans_test = args.ruta_features_test2
    ...
    def build_optimizer(projection_model, optimizer, learning_rate, momentum):
        ...
        if optimizer == "sgd":
            optimizer = optim.SGD([params1, params2, params3, params4, params5], lr=learning_rate, momentum=momentum)
        elif optimizer == "adam":
            optimizer = optim.Adam([params1, params2, params3, params4, params5], lr=learning_rate)
    ...
    def train():
        ...
        projection_model = md.LLaVA_CLIP(hidden_dim=hidden_dim, num_layers=num_layers, dropout=dropout,pretrained=pretrained) 
        projection_model = projection_model.to(device)

        #DataLoader
        dataloader = get_dataloader(ruta_features_train, batch_size)
        dataloader_cis_val = get_dataloader(ruta_features_cis_val,batch_size)
        dataloader_cis_test = get_dataloader(ruta_features_cis_test, batch_size)
        dataloader_trans_val = get_dataloader(ruta_features_trans_val, batch_size)
        dataloader_trans_test = get_dataloader(ruta_features_trans_test, batch_size)
