...
import argparse
import datetime
from models import CATALOG_Base_long as md
import pandas as pd
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ruta_features_train', type=str,
                        default="../../../features/Features_serengeti/long_standard_features/Features_CATALOG_train_longclip-B.pt",
                        help='Training path')
    parser.add_argument('--ruta_features_val', type=str,
                        default="../../../features/Features_serengeti/long_standard_features/Features_CATALOG_val_longclip-B.pt",
                        help='Validation path')
    parser.add_argument('--ruta_features_test1', type=str,
                        default="../../../features/Features_terra/long_standard_features/Features_CATALOG_cis_test_longclip-B.pt",
                        help='Test path 1')
    parser.add_argument('--ruta_features_test2', type=str,
                        default="../../../features/Features_terra/long_standard_features/Features_CATALOG_trans_test_longclip-B.pt",
                        help='Test path 2')
    parser.add_argument('--text_features', type=str,
                        default="../../../features/Features_serengeti/long_standard_features/Text_longclip-B.pt",
    ...
    parser.add_argument('--text_features2', type=str,
                        default="../../../features/Features_terra/long_standard_features/Text_longclip-B.pt",
    ...
    path_text_feat1=args.text_features
    path_text_feat2 = args.text_features2
    ...
    def train():
        ...
        text_features = torch.load(path_text_feat1)
        ...
        for epoch in range(num_epochs):
            ...
            if epoch==(num_epochs-1) or counter >= patience:
                ...
                df_conf_matrix_cis.to_csv('conf_matrix_cis_V1_16.csv', index=False)
                conf_matrix_trans = confusion_matrix(all_labels_trans, all_preds_trans)
                df_conf_matrix_trans = pd.DataFrame(conf_matrix_trans)
                df_conf_matrix_trans.to_csv('conf_matrix_trans_V1_16.csv', index=False)
    ...
    def prueba_model(model_params_path):# to calculate the acc in test for a saved model
        ...
        conf_matrix_cis = confusion_matrix(all_labels_cis, all_preds_cis)
        df_conf_matrix_cis = pd.DataFrame(conf_matrix_cis)
        df_conf_matrix_cis.to_csv('conf_matrix_cis.csv', index=False)

        conf_matrix_trans = confusion_matrix(all_labels_trans, all_preds_trans)
        df_conf_matrix_trans = pd.DataFrame(conf_matrix_trans)
        df_conf_matrix_trans.to_csv('conf_matrix_trans.csv', index=False)
