...
import argparse
import datetime
from models import CATALOG_Base_fine_tuning_last_layer as md
import pandas as pd
...
if __name__ == "__main__":
    ...
    def build_optimizer(projection_model, optimizer, learning_rate, momentum):
        ...
        params4 = {"params": projection_model.model_clip.visual.proj, "lr": learning_rate,
                   "momentum": momentum}
    ...
    wandb.init(
        project="Train_CLIP_V1_out_domain",
    )
    train()
    wandb.finish()