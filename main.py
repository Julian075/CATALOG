        ...
        if train_type=="Out_domain":
            if hyperparameterTuning_mode == 1 or hyperparameterTuning_mode == 2:
                ...
                if hyperparameterTuning_mode == 1:
                    ...
                    test_best_model([features_D, features_S],train_type, model_version,model, f'AB_110{model_version}_{train_type}_{LLM}_{beta}_alpha_{alpha}',config[model_version], seeds,sup_loss=sup_loss)
